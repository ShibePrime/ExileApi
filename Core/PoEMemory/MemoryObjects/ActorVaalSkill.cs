namespace ExileCore.PoEMemory.MemoryObjects
{
    public class ActorVaalSkill : RemoteMemoryObject
    {
        ...
        public string VaalSkillInternalName => M.ReadStringU(M.Read<long>(Address + NAMES_POINTER_OFFSET) + INTERNAL_NAME_OFFSET);
        public string VaalSkillDisplayName => M.ReadStringU(M.Read<long>(Address + NAMES_POINTER_OFFSET) + NAME_OFFSET);
        public string VaalSkillDescription => M.ReadStringU(M.Read<long>(Address + NAMES_POINTER_OFFSET) + DESCRIPTION_OFFSET);
        public string VaalSkillSkillName => M.ReadStringU(M.Read<long>(Address + NAMES_POINTER_OFFSET) + SKILL_NAME_OFFSET);
        public string VaalSkillIcon => M.ReadStringU(M.Read<long>(Address + NAMES_POINTER_OFFSET) + ICON_OFFSET);
