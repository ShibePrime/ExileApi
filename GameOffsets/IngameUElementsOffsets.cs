...
namespace GameOffsets
{
    ...
    public struct IngameUElementsOffsets
    {
        ...
        [FieldOffset(0x748)] public long LeagueNpcDialog;
        ...
        [FieldOffset(0x778)] public long ExpeditionSellWindow;
        ...
        [FieldOffset(0x848)] public long BetrayalWindow;
        [FieldOffset(0x858)] public long CraftBenchWindow;
        [FieldOffset(0x860)] public long UnveilWindow;
        [FieldOffset(0x888)] public long SynthesisWindow;
        [FieldOffset(0x8A0)] public long MetamorphWindow;
        [FieldOffset(0x8A8)] public long HorticraftingSacredGrovePanel;
        [FieldOffset(0x8B0)] public long HorticraftingHideoutPanel;
        [FieldOffset(0x8B8)] public long HeistContractPanel;
        [FieldOffset(0x8C0)] public long HeistRevealPanel;
        [FieldOffset(0x8C8)] public long HeistAllyEquipmentPanel;
        [FieldOffset(0x8D0)] public long HeistBlueprintPanel;
        [FieldOffset(0x8D8)] public long HeistLockerPanel;
        [FieldOffset(0x8E0)] public long RitualWindow;
        [FieldOffset(0x8E8)] public long RitualFavourPanel;
        [FieldOffset(0x8F0)] public long UltimatumProgressPanel;
        [FieldOffset(0x918)] public long ArchNemesis;
        [FieldOffset(0x958)] public long DelveDarkness; // Is actually debuff panel.
        [FieldOffset(0x998)] public long AreaInstanceUi;
